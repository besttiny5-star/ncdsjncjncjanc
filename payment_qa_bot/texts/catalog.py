...
TEXTS = TextCatalog(
    messages={
        "en": {
            ...
            "wizard.tests": "🧪 Step 2 — Number of test payments\n\nSend how many successful transactions we should perform (1-100).",
            "wizard.method": "💳 Step 3 — Payment method\n\nSelect the payment method to be tested from the list below.",
            ...
            "wizard.password": "Step 8 — Password for testers\n\nSend the password or choose Skip.",
            "wizard.skip": "Skip",
            "wizard.back": "◀️ Back",
            ...
            "confirmation.accepted": "✅ Order #{order_id} has been created. We will wait for the payment.",
            "confirmation.duplicate": "We already have order #{order_id}. Current status: {status}.",
            ...
            "group.prompt": "Please message the bot directly to place an order.",
            "group.open": "Open chat",
        },
        "ru": {
            ...
            "wizard.tests": "🧪 Шаг 2 — Количество оплат\n\nСколько реальных платежей требуется выполнить? Укажите число от 1 до 100.",
            "wizard.method": "💳 Шаг 3 — Метод оплаты\n\nВыберите способ оплаты для теста из списка ниже.",
            ...
            "wizard.comments": "📝 Шаг 5 — Комментарии\n\nПришлите пожелания текстом или нажмите «Пропустить».",
            ...
            "wizard.password": "Шаг 8 — Пароль для тестеров\n\nПришлите пароль или пропустите.",
            ...
            "confirmation.accepted": "✅ Заявка #{order_id} создана. Ждём оплату.",
            "confirmation.duplicate": "Такая заявка уже есть под номером #{order_id}. Текущий статус: {status}.",
            ...
            "group.prompt": "Пожалуйста, напишите боту в личные сообщения, чтобы оформить заказ.",
            "group.open": "Открыть чат",
        },
    }
)
